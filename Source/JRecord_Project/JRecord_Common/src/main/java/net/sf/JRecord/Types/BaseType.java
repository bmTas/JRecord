...
public abstract class BaseType implements Type {
    ...
    public BaseType(final boolean leftJustified) {
...
//     */
//    public BaseType(final boolean leftJustified, boolean padByteOveride) {
...
//    }
     ...
     */
    public BaseType(final boolean leftJustified, final boolean binaryField, final boolean num) {
    	this(leftJustified, false, binaryField, num, true);
    }
    
    public BaseType(final boolean leftJustified, boolean padByteOveride, final boolean binaryField, final boolean num, boolean trim) {
        super();
