...
public class Code2JRecordConstants {
	...
	private static final ConstantConversions CONSTANT_CONVERSIONS = ConstantNames.getConstantConversions();
...
//	
	...
	public static String getJRecordTypeName(int type) {
		if (JAVA_TYPE_NAME [Type.ftPackedDecimalSmall       ] == null) {
		...
		return CONSTANT_CONVERSIONS.getTypeNames().getJRecordConstantName(type);
	}
...
//	}
	...
	public static String getRecordTypeName(int recType) {
		return CONSTANT_CONVERSIONS.getRecordTypes().getJRecordConstantName(recType);		
	}
...
//	}
	...
	public static String getDialectName(int dialect) {
		return CONSTANT_CONVERSIONS.getDialects().getJRecordConstantName(dialect);
	}
...
//	}
	...
	public static String getSplitName(int split) {
		return CONSTANT_CONVERSIONS.getSplitOptions().getJRecordConstantName(split);
	}
...
//	}
	...
	public static String getCopybookFormatName(int format) {
		return CONSTANT_CONVERSIONS.getCopybookFormat().getJRecordConstantName(format);
	}
...
//		}
//		
//		return "IFileStructureConstants." + IO_TYPE[type];
//	}
//
//	@SuppressWarnings("deprecation")
