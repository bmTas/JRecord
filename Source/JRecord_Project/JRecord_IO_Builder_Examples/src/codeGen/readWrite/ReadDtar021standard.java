...
*/
public final class ReadDtar021standard {

 
   /**
    * Example of LineReader  classes
    */
   public ReadDtar021standard() {
       super();
       String dataFile        = getFilePath("DTAR020.bin");
       String copybookName    = getFilePath("DTAR020.bin");
       ...
       try {
           ...
           while ((line = reader.read()) != null) {
               ...
               System.out.println(
                     ...
                     + " " + line.getFieldValue(rDtar021.theDate).asString()
                     + " " + line.getFieldValue(rDtar021.deptNo).asString()
