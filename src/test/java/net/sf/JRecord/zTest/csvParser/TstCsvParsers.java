...
public class TstCsvParsers  {
	...
	@Test public void testByteCsvParser1() {
	...
	@Test public void testByteCsvParser2() {
		BasicCsvByteLineParserExtended parser = BasicCsvByteLineParserExtended.getInstance();
		CsvDefinition csvDef = new CsvDefinition(",", "\"");
	...
	@Test public void testByteCsvParser3() {
		BasicCsvByteLineParserExtended parser = BasicCsvByteLineParserExtended.getInstance();
		tstCsvParser3(parser);
		tstByteCsvParser4(parser);
	}
	
	@Test public void testByteCsvParser5() {
	...
	@Test public void testStringCsvParser() {
	...
	@Test public void testStringCsvParser2() {
		BasicCsvLineParserExtended parser = BasicCsvLineParserExtended.getInstance();
		CsvDefinition csvDef = new CsvDefinition(",", "\"");
	...
	@Test public void testStrinCsvParser3() {
		BasicCsvLineParserExtended parser = BasicCsvLineParserExtended.getInstance();
		tstCsvParser3(parser);
		tstByteCsvParser4(parser);
	}

	@Test public void testStrinCsvParser3a() {
		BasicCsvLineParserExtended parser = BasicCsvLineParserExtended.getInstance();
		CsvDefinition csvDef = new CsvDefinition(",", "\"");
	...
	@Test public void testStringCsvParser5() {
		tstCsvParser5(BasicCsvLineParserExtended.getInstance());
	}
	@Test public void testStringCsvParser5a() {
		BasicCsvLineParserExtended parser = BasicCsvLineParserExtended.getInstance();
		CsvDefinition csvDef = new CsvDefinition(",", "\"");
