...
public class TstCsvLines   {
	...
	private static JUnit3Test testCases = new JUnit3Test();
	...
	@Test public void testBasic1() throws RecordException {
	...
	@Test public void testStandard1() throws RecordException {
	...
	@Test public void testQuoteChar1() throws RecordException {
	...
	@Test public void testBasic2() throws RecordException {
		LayoutDetail l = bldLayout1(CsvParserManagerChar.BASIC_CSV_PARSER);
	...
	@Test public void testStandard2() throws RecordException {
		LayoutDetail l = bldLayout1(CsvParserManagerChar.STANDARD_CSV_PARSER);
		IUpdateFld u = new UpdateByField();
	...
	@Test public void testQuoteChar2() throws RecordException {
		LayoutDetail l = bldLayout1(CsvParserManagerChar.DB_CSV_PARSER);
		IUpdateFld u = new UpdateByField();
	...
	private static class UpdateByIndex implements IUpdateFld {
		public void setCheckFld(String id, AbstractLine[] lines, int flNum, String value, String[] values, int m) throws RecordException {
			...
			testCases.assertEqualsV3o(id, text, lines[1].getFullLine());
			testCases.assertEqualsV3o(id, text, lines[2].getFullLine());
			
			lines[0].setData(text);
			lines[1].setData(text);
			lines[2].setData(text);

			testCases.assertEqualsV3o(id, text, lines[0].getFullLine());
			testCases.assertEqualsV3o(id, text, lines[1].getFullLine());
			testCases.assertEqualsV3o(id, text, lines[2].getFullLine());
...
//			System.out.println(lines[0].getFullLine());
			for (AbstractLine line : lines) {
				for (int i = 0; i < values.length; i++) {
					testCases.assertEqualsV3o(id + " " + line.getClass().getName() + " " + i, 
		...
		public void setFld(String id, AbstractLine[] lines, int flNum, String value) throws RecordException {
			for (AbstractLine line : lines) {
				...
				testCases.assertEqualsV3o(id, value, line.getFieldValue(0, Math.abs(flNum)).asString());
			}
		}
	}
...
//			System.out.println(lines[0].getFullLine());
		...
		public void setFld(String id, AbstractLine[] lines, int flNum, String value) throws RecordException {
			...
			for (AbstractLine line : lines) {
				line.getFieldValue(0, Math.abs(flNum)).set(value);
				testCases.assertEqualsV3o(id, value, line.getFieldValue(l.getRecord(0).getField(Math.abs(flNum))).asString());
			}
		}
	}
