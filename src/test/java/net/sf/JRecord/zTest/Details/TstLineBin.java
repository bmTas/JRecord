 ...
 *
 */
public class TstLineBin extends JUnit3Test {
 ...
 //   private static LayoutDetail copyBook = null;
	...
	@Test public void testGetField() throws Exception {
        ...
        assertEqualsV3o(" 1 GetField - Character Field " + line.getField(0, 0 + xmlTotal),
                "asdf", line.getField(0, 0));
        assertEqualsV3o(" 2 GetField - Character Field ", "    qwerty", line.getField(0, 1 + xmlTotal));
 //       assertEquals(" 3 GetField - Decimal Field ", "123", line.getField(0, 2 + xmlTotal));
        assertEqualsV3o(" 7 GetField - Num Right Just", "123", line.getField(0, 6 + xmlTotal));
        assertEqualsV3o(" 8 GetField - Num Zero Padded Field ", "456", line.getField(0, 7));
        assertEqualsV3o("10 GetField - Assumed Decimal ", "123.4500", line.getField(0, 9).toString());
        assertEqualsV3o("11 GetField - Num 2 Decimal ", "23.67", line.getField(0, 10));
//        assertEquals("12 GetField - Decimal ", "45.67", line.getField(0, 11));
        //assertEquals("13 GetField - Positive Int ", "123.45", line.getField(0, 12));

        assertEqualsV3o("14 GetField - Num 2 Decimal Digits ", "234.56", line.getField(0, 13));
        ...
        assertEqualsV3o("23 GetField - Mainframe Packed ", "1234", line.getField(0, 22).toString());
        assertEqualsV3o("24 GetField - Mainframe Packed with decimal", "123.0", line.getField(0, 23).toString());

        assertEqualsV3o("25 GetField - Mainframe Zoned ", "-12", line.getField(0, 24).toString());
        assertEqualsV3o("26 GetField - Mainframe Zoned with decimal", "-0.12", line.getField(0, 25).toString());
        ...
        assertEqualsV3o("15 GetField - Mainframe Binary ", "321", line1.getField(0, 14).toString());
        assertEqualsV3o("16 GetField - Mainframe Binary with Decimal", "4000000.00", line1.getField(0, 15).toString());
        assertEqualsV3o("21 GetField - Mainframe Small Int ", "31000", line1.getField(0, 20).toString());
        assertEqualsV3o("22 GetField - Mainframe Long ", "100000000000000000", line1.getField(0, 21).toString());
    }
     ...
     */
    @Test public void testGetFieldText() {
    	//"436857cf"
    	byte[] b = {0x43, 0x68, 0x57, (byte) 0xcf};
        assertEqualsV3o("GetFieldText - Character Field ", "asdf", line.getFieldText(0, 0));
        assertEqualsV3o("GetFieldText - Character Field ", "    qwerty", line.getFieldText(0, 1));

 //       assertEquals("GetFieldText - 4 >> ", "ChW�", line.getFieldText(0, 4));
 //       assertEquals("GetFieldText - 4 >> ", "ChW�", line.getFieldText(0, 4));
        assertEqualsV3o("GetFieldText - 4 >> ", new String(b), line.getFieldText(0, 4));
        assertEqualsV3o("GetFieldText - 5 >> ", "3456", line.getFieldText(0, 5));
        assertEqualsV3o("GetFieldText - 6 >> ", "     123", line.getFieldText(0, 6));
    }
     ...
     */
    @Test public void testGetFieldHex() {

        assertEqualsV3o("GetFieldHex - GetHex", "15030000", line.getFieldHex(0,  8));
        assertEqualsV3o("GetFieldHex - GetHex", "39300000", line.getFieldHex(0, 12));

        System.out.println("\"" + line.getFieldHex(0, 3) + "\"");
        System.out.println("\"" + line.getFieldHex(0, 4) + "\"");
        assertEqualsV3o("GetFieldHex - GetHex 1 ", "20202020717765727479", line.getFieldHex(0, 1));
        assertEqualsV3o("GetFieldHex - GetHex 2 ", "0000000123", line.getFieldHex(0, 2));
        assertEqualsV3o("GetFieldHex - GetHex 3 ", "405e4ed916872b02", line.getFieldHex(0, 3));
        assertEqualsV3o("GetFieldHex - GetHex 4 ", "436857cf", line.getFieldHex(0, 4));
        assertEqualsV3o("GetFieldHex - GetHex 5 ", "3334353620202020", line.getFieldHex(0, 5));
        assertEqualsV3o("GetFieldHex - GetHex 6 ", "2020202020313233", line.getFieldHex(0, 6));
        assertEqualsV3o("GetFieldHex - GetHex 7 ", "3030303030343536", line.getFieldHex(0, 7));
        assertEqualsV3o("GetFieldHex - GetHex 9 ", "30303031323334353030", line.getFieldHex(0, 9));

        assertEqualsV3o("GetFieldHex - GetHex 11 ", "0000004567", line.getFieldHex(0, 11));
        assertEqualsV3o("GetFieldHex - GetHex 10 ", "202020202032332e3637", line.getFieldHex(0, 10));
        assertEqualsV3o("GetFieldHex - GetHex 13 ", "3233342e3536", line.getFieldHex(0, 13));
        assertEqualsV3o("GetFieldHex - GetHex 14 ", "00000141", line.getFieldHex(0, 14));

    }

    @Test public void testGetFieldValueString() throws Exception {

        assertEqualsV3o(" 1 GetFieldValue - Character Field " + line.getFieldValue(0, 0).asString(),
                "asdf", line.getFieldValue(0, 0).asString());
        assertEqualsV3o(" 2 GetFieldValue - Character Field ", "    qwerty", line.getFieldValue(0, 1).asString());
//        assertEquals(" 3 GetFieldValue - Decimal Field ", "123", line.getFieldValue(0, 2).asString());
        assertEqualsV3o(" 7 GetFieldValue - Num Right Just", "123", line.getFieldValue(0, 6).asString());
        assertEqualsV3o(" 8 GetFieldValue - Num Zero Padded Field ", "456", line.getFieldValue(0, 7).asString());
        assertEqualsV3o("10 GetFieldValue - Assumed Decimal ", "123.4500", line.getFieldValue(0, 9).asString());
        assertEqualsV3o("11 GetFieldValue - Num 2 Decimal ", "23.67", line.getFieldValue(0, 10).asString());
 //       assertEquals("12 GetFieldValue - Decimal ", "45.67", line.getFieldValue(0, 11).asString());
        ...
        assertEqualsV3o("14 GetFieldValue - Num 2 Decimal Digits ", "234.56", line.getFieldValue(0, 13).asString());
        ...
        assertEqualsV3o("23 GetFieldValue - Mainframe Packed ", "1234", line.getFieldValue(0, 22).asString());
        assertEqualsV3o("24 GetFieldValue - Mainframe Packed with decimal", "123.0", line.getFieldValue(0, 23).asString());

        assertEqualsV3o("25 GetFieldValue - Mainframe Zoned ", "-12", line.getFieldValue(0, 24).asString());
        assertEqualsV3o("26 GetFieldValue - Mainframe Zoned with decimal", "-0.12", line.getFieldValue(0, 25).asString());
        ...
        assertEqualsV3o("15 GetFieldValue - Mainframe Binary ", "321", line1.getFieldValue(0, 14).asString());
        assertEqualsV3o("16 GetFieldValue - Mainframe Binary with Decimal", "4000000.00", line1.getFieldValue(0, 15).asString());
        assertEqualsV3o("21 GetFieldValue - Mainframe Small Int ", "31000", line1.getFieldValue(0, 20).asString());
        assertEqualsV3o("22 GetFieldValue - Mainframe Long ", "100000000000000000", line1.getFieldValue(0, 21).asString());
    }
...
//        checkDecimal(line, "12 GetFieldValue - Decimal ", "45.67", 11);
        ...
        assertEqualsV3o("22 GetFieldValue - Mainframe Long  e) ",
...
//        	int i =  line.getFieldValue(0, fld).asInt();
        ...
        assertEqualsV3i(id + " a) ", Integer.parseInt(val), pLine.getFieldValue(0, fld + xmlTotal).asInt());
        checkDecimal(pLine, id, val,  fld);
        assertEqualsV3o(id + " e) ", new BigInteger(val), pLine.getFieldValue(0, fld + xmlTotal).asBigInteger());
    }
    ...
    private void checkDecimal(AbstractLine pLine, String id, String val, int fld) {
    	...
    	org.junit.jupiter.api.Assertions.assertEquals(
    			...
    			pLine.getFieldValue(0, fld + xmlTotal).asFloat(), 0.000001, 
    			id + " b) ");
    	org.junit.jupiter.api.Assertions.assertEquals(
    			Double.parseDouble(val), 
    			pLine.getFieldValue(0, fld + xmlTotal).asDouble(),
    			0.000001, id + " c) ");
        assertEqualsV3o(id + " d) ", new BigDecimal(val), pLine.getFieldValue(0, fld + xmlTotal).asBigDecimal());
    }
     ...
     */
    @Test public void testSetField() throws RecordException {
...
//        checkAssignment(" 8n1 setField - Num Zero Padded Field ", 7, "-876");
    ...
    @Test public void testSetFieldMainframe() throws Exception {
        LayoutDetail copyBook1 = 
                copybookInt.loadCopyBook(
                        TstConstants.COBOL_DIRECTORY + copyBookName + ".cbl",
                        CopybookLoader.SPLIT_NONE, 0, "",
	...
	private void checkAssignment(String msg, int fldNum,  String val)
        ...
        assertEqualsV3o(msg + " " + s + " <> " + val, val, s);
    }
	...
	private void checkAssignmentHex(String msg, int fldNum,  String val, String hexVal)
        ...
        assertEqualsV3o(msg + " hex check " + s + " <> " + hexVal, hexVal, s);
/*        if (!s.equals(hexVal)) {
     ...
     */
    @Test public void testSetFieldConversion() {
...
//        checkConversionError("28a setField - Bit 2byte ", 27, "20000100101010101");
     ...
     * Test Line.setFieldConversion
     */
    @Test public void testSetFieldSizeError() {
    ...
    @Test public void testGetRecord() {
        ...
        assertTrueV3("getRecord Error ", Arrays.equals(rec, line.getData()));
    }
	...
	@Test public void testMainframe() throws Exception {
        ...
        System.out.println("Mainframe rec Lengths=> " + recDtar020.length
                		 + " " + r.length);
        assertTrueV3("getRecord Error ", Arrays.equals(recDtar020, r));
    }
