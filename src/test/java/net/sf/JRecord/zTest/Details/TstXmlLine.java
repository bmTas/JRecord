 ...
 *
 */
public class TstXmlLine  extends JUnit3Test {
	...
	@Test public void testGetField() throws Exception {
        ...
        assertEqualsV3o(" 1 GetField - Character Field " + getLineField( 0),
                "asdf", getLineField( 0));
        assertEqualsV3o(" 2 GetField - Character Field ", "    qwerty", getLineField( 1));
//        assertEquals(" 3 GetField - Decimal Field ", "123", getLineField( 2));
        assertEqualsV3o(" 7 GetField - Num Right Just", "123", getLineField( 6));
        assertEqualsV3o(" 8 GetField - Num Zero Padded Field ", "456", getLineField( 7));
        assertEqualsV3o("10 GetField - Assumed Decimal ", "123.4500", getLineField( 9));
        assertEqualsV3o("11 GetField - Num 2 Decimal ", "23.67", getLineField( 10));
//        assertEquals("12 GetField - Decimal ", "45.67", getLineField( 11));
        //assertEquals("13 GetField - Positive Int ", "123.45", getLineField( 12));

        assertEqualsV3o("14 GetField - Num 2 Decimal Digits ", "234.56", getLineField( 13));
        ...
        assertEqualsV3o("23 GetField - Mainframe Packed ", "1234", getLineField( 22));
        assertEqualsV3o("24 GetField - Mainframe Packed with decimal", "123.0", getLineField( 23));

        assertEqualsV3o("25 GetField - Mainframe Zoned ", "-12", getLineField( 24));
        assertEqualsV3o("26 GetField - Mainframe Zoned with decimal", "-0.12", getLineField( 25));
    ...
    @Test public void testGetFieldText() {
        ...
        assertEqualsV3o("GetFieldText - Character Field ", "asdf", line.getFieldText(1, 0 + xmlTotal));
        assertEqualsV3o("GetFieldText - Character Field ", "    qwerty", line.getFieldText(0, 1 + xmlTotal));
    ...
    @Test public void testGetFieldValueString() throws Exception {
        ...
        assertEqualsV3o(" 1 GetFieldValue - Character Field " + line.getFieldValue(1, xmlTotal + 0).asString(),
                "asdf", line.getFieldValue(1, xmlTotal + 0).asString());
        assertEqualsV3o(" 2 GetFieldValue - Character Field ", "    qwerty", line.getFieldValue(1, xmlTotal + 1).asString());
//        assertEquals(" 3 GetFieldValue - Decimal Field ", "123", line.getFieldValue(1, xmlTotal + 2).asString());
        assertEqualsV3o(" 7 GetFieldValue - Num Right Just", "123", line.getFieldValue(1, xmlTotal + 6).asString());
        assertEqualsV3o(" 8 GetFieldValue - Num Zero Padded Field ", "456", line.getFieldValue(1, xmlTotal + 7).asString());
        assertEqualsV3o("10 GetFieldValue - Assumed Decimal ", "123.4500", line.getFieldValue(1, xmlTotal + 9).asString());
        assertEqualsV3o("11 GetFieldValue - Num 2 Decimal ", "23.67", line.getFieldValue(1, xmlTotal + 10).asString());
//        assertEquals("12 GetFieldValue - Decimal ", "45.67", line.getFieldValue(1, xmlTotal + 11).asString());
        ...
        assertEqualsV3o("14 GetFieldValue - Num 2 Decimal Digits ", "234.56", line.getFieldValue(1, xmlTotal + 13).asString());
        ...
        assertEqualsV3o("23 GetFieldValue - Mainframe Packed ", "1234", line.getFieldValue(1, xmlTotal + 22).asString());
        assertEqualsV3o("24 GetFieldValue - Mainframe Packed with decimal", "123.0", line.getFieldValue(1, xmlTotal + 23).asString());

        assertEqualsV3o("25 GetFieldValue - Mainframe Zoned ", "-12", line.getFieldValue(1, xmlTotal + 24).asString());
        assertEqualsV3o("26 GetFieldValue - Mainframe Zoned with decimal", "-0.12", line.getFieldValue(1, xmlTotal + 25).asString());
        ...
        assertEqualsV3o("15 GetFieldValue - Mainframe Binary ", "321", line1.getFieldValue(1, xmlTotal + 14).asString());
        assertEqualsV3o("16 GetFieldValue - Mainframe Binary with Decimal", "4000000.00", line1.getFieldValue(1, xmlTotal + 15).asString());
        assertEqualsV3o("21 GetFieldValue - Mainframe Small Int ", "31000", line1.getFieldValue(1, xmlTotal + 20).asString());
        assertEqualsV3o("22 GetFieldValue - Mainframe Long ", "100000000000000000", line1.getFieldValue(1, xmlTotal + 21).asString());
    }
...
//        	int i =  line.getFieldValue(0, fld).asInt();
        ...
        assertEqualsV3i(id + " a) ", Integer.parseInt(val), pLine.getFieldValue(1, fld + xmlTotal).asInt());
        checkDecimal(pLine, id, val,  fld);
        assertEqualsV3o(id + " e) ", new BigInteger(val), pLine.getFieldValue(1, fld + xmlTotal).asBigInteger());
    }
    ...
    private void checkDecimal(AbstractLine pLine, String id, String val, int fld) {
       	...
       	org.junit.jupiter.api.Assertions.assertEquals(
       			Float.parseFloat(val), pLine.getFieldValue(1, fld + xmlTotal).asFloat(), 0.000001,
       			id + " b) ");
       	org.junit.jupiter.api.Assertions.assertEquals(
       			Double.parseDouble(val), pLine.getFieldValue(1, fld + xmlTotal).asDouble(), 0.000001,
       			id + " c) ");
        assertEqualsV3o(id + " d) ", new BigDecimal(val), pLine.getFieldValue(1, fld + xmlTotal).asBigDecimal());
    }
