...
public class TstFieldSelectX1 extends JUnit3Test {
	...
	@Test public void testGetTextField() {
		FieldSelect fs;
		String num;
		...
		for (int i = 0; i < GET_RESULTS_TEXT_FIELD.length; i++) {
			...
			assertEqualsV3o("Checking Class For: " + GET_RESULTS_TEXT_FIELD[i][0], GET_RESULTS_TEXT_FIELD[i][1], fs.getClass().getName());
			assertEqualsV3o("Checking Numeric For: " + GET_RESULTS_TEXT_FIELD[i][0], GET_RESULTS_TEXT_FIELD[i][2], num);
	...
	@Test public void testGetNumField() {
		FieldSelect fs;
		String num;
		...
		for (int i = 0; i < GET_RESULTS_NUM_FIELD.length; i++) {
			...
			assertEqualsV3o("Checking Class For: " + GET_RESULTS_NUM_FIELD[i][0], GET_RESULTS_NUM_FIELD[i][1], fs.getClass().getName());
			assertEqualsV3o("Checking Numeric For: " + GET_RESULTS_NUM_FIELD[i][0], GET_RESULTS_NUM_FIELD[i][2], num);
//			System.out.println("\t{\"" + Constants.VALID_COMPARISON_OPERATORS[i]
//					+"\", \"" + fs.getClass().getName() + "\", \"" + num + "\"}," );
		}
	}
	...
	@Test public void testRegExp() {
		...
		for (String[] tstData : data) {
			...
			assertEqualsV3o(line.getFullLine() + " >" + tstData[0] + " >" + tstData[1],
					"t".equals(tstData[2]),
					fs.isSelected(line));
		} 
	}
