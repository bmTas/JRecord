...
public class TstCobolGroupAccess extends JUnit3Test  {
	...
	@Test public void testGroupArray1() throws RecordException, IOException {
	...
	@Test public void testGroupArray2() throws RecordException, IOException {
		ICobolIOBuilder ioBldr = JRecordInterface1.COBOL
	...
	private void check(String id, IFieldDetail fld) {
		assertTrueV3(id, fld != null);
		assertEqualsV3o(id, FIELD_NAME, fld.getName());
