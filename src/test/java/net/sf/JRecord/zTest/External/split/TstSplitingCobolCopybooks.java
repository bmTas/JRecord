...
public class TstSplitingCobolCopybooks extends JUnit3Test  {
	...
	@Test public void testRepeating()  throws RecordException, IOException {
	...
	@Test public void testRedef()  throws RecordException, IOException {
	...
	private void tstImport(String copybook, int splitOption) throws RecordException, IOException {
    	...
    	for (int i = 0; i < schema.getRecordCount(); i++) {
			...
			for (int j = 0; j < record.getFieldCount(); j++) {
				...
				assertEqualsV3o(id, expectedField.name, field.getName());			
				assertEqualsV3i(id, expectedField.pos,  field.getPos());			
				assertEqualsV3i(id, expectedField.len,  field.getLen());			
				assertEqualsV3i(id, expectedField.type, field.getType());			
			}
    	}
	}
