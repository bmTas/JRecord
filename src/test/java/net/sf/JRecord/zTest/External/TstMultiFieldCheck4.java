...
public class TstMultiFieldCheck4 extends JUnit3Test  {
	...
	@Test public void test1() throws RecordException, Exception {
	...
	@Test public void test2() throws RecordException, Exception {
		LayoutDetail l = getLayout();
		Line line;
	...
	@Test public void testLayoutParent() throws Exception {
		...
		assertEqualsV3i("Record Count ", parentIdxs.length,  xRec.getNumberOfRecords());
		for (int i = 0; i < xRec.getNumberOfRecords(); i++) {
			s = "";
			parent = xRec.getRecord(i).getParentRecord();
			if (parent >= 0) {
			...
			assertEqualsV3o("Parent Name" , parentNames[i], s);
			assertEqualsV3i("Parent Index", parentIdxs[i], parent);
		}
	}
	
	@Test public void testLayoutFieldNames() throws Exception {
		String[][] fieldNames = {
		...
		assertEqualsV3i("Record Count ", fieldNames.length, xRec.getNumberOfRecords());
		for (int i = 0; i < xRec.getNumberOfRecords(); i++) {
			cRec = xRec.getRecord(i);
			
			assertEqualsV3i("Field Count ", fieldNames[i].length, cRec.getNumberOfRecordFields());
			for (int j = 0; j < cRec.getNumberOfRecordFields(); j++) {
				assertEqualsV3o("Field " + i + ", " + j + " ", cRec.getRecordField(j).getName(), fieldNames[i][j]);
			}
		}
	}

	@Test public void testLayoutFieldPos() throws Exception {
		int[][] fieldPos = {
				{1, 3, 5, 9, 17, },
				{1, 3, 5, 9, 17, },
				{1, 3, 5, 11, 26, },
		...
		assertEqualsV3i("Record Count ", fieldPos.length, xRec.getNumberOfRecords());
		for (int i = 0; i < xRec.getNumberOfRecords(); i++) {
			cRec = xRec.getRecord(i);
			
			assertEqualsV3i("Field Count ", fieldPos[i].length, cRec.getNumberOfRecordFields());
			for (int j = 0; j < cRec.getNumberOfRecordFields(); j++) {
				assertEqualsV3i("Field " + i + ", " + j + " ", cRec.getRecordField(j).getPos(), fieldPos[i][j]);
			}
		}
	}


	@Test public void testLayoutFieldLength() throws Exception {
		int[][] fieldLen = {
				{1, 2, 4, 8, 3, },
				{1, 2, 4, 8, 3, },
				{1, 2, 6, 9, 3, },
		...
		assertEqualsV3i("Record Count ", fieldLen.length, xRec.getNumberOfRecords());
		for (int i = 0; i < xRec.getNumberOfRecords(); i++) {
			cRec = xRec.getRecord(i);
			
			assertEqualsV3i("Field Count ", fieldLen[i].length, cRec.getNumberOfRecordFields());
			for (int j = 0; j < cRec.getNumberOfRecordFields(); j++) {
				assertEqualsV3i("Field Length " + i + ", " + j + " ", cRec.getRecordField(j).getLen(), fieldLen[i][j]);
			}
		}
	}
	

	@Test public void testLayoutFieldType() throws Exception {
		int[][] fieldType = {
				{0, 0, 0, 7, 0, },
				{0, 0, 0, 7, 0, },
				{0, 0, 0, 7, 0, },
		...
		assertEqualsV3i("Record Count ", fieldType.length, xRec.getNumberOfRecords());
		for (int i = 0; i < xRec.getNumberOfRecords(); i++) {
			cRec = xRec.getRecord(i);
			
			assertEqualsV3i("Field Count ", fieldType[i].length, cRec.getNumberOfRecordFields());
			for (int j = 0; j < cRec.getNumberOfRecordFields(); j++) {
				assertEqualsV3i("Field Type " + i + ", " + j + " ", cRec.getRecordField(j).getType(), fieldType[i][j]);
			}
		}
	}
