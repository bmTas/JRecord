...
public class TstFixedHelper   {

	@Test public void testCreateRecord() {
		String[] fonts = {"", "IBM037"};
	...
	@Test public void testAddFieldByLength() {
	...
	@Test public void testAddFieldByPos() {
		int[] types = {Type.ftChar, Type.ftNumAnyDecimal, Type.ftNumLeftJustified};
		int p = 1;
		int[] maxDecimal = {0, 0, 2};
		int i = 0;
	...
	@Test public void testAddFieldByPosLen() {
		int[] types = {Type.ftChar, Type.ftNumAnyDecimal, Type.ftNumLeftJustified};
		int p = 1;
		int[] maxDecimal = {0, 0, 2};
		int i = 0;
