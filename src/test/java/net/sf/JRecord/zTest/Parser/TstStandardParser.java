...
public class TstStandardParser extends JUnit3Test  {
	...
	@Test public void testSetField3() {
			...
			for (int i = 0; i < lines1.length - 1; i++) {
				for (j = 0; j < 3; j++) {
					...
					after = p.getField(j, s, new CsvDefinition("|", "'"));
					System.out.println(i + ", " + j + " > " + before + " => " + after);
					assertEqualsV3o("Error in " + i +":" + j + "bb got " + after, after, before);
					...
					assertEqualsV3o("Error in " + i +":" + j + "ca got " + after, after, "'" + before + "'");
					after = p.getField(j, s, new CsvDefinition(",", "'"));
					assertEqualsV3o("Error in " + i +":" + j + "cb got " + after, after, before);
					System.out.println();
