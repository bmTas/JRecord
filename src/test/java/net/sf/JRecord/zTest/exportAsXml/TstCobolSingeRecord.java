 ...
 *
 */
public class TstCobolSingeRecord   {
...
//		createField("RBI-TEXTE-2", ".RBI-RECORD-T2.",96, 50, 0, 0),
	...
	@Test public void testCopybookFields() throws IOException, XMLStreamException, FactoryConfigurationError {
	...
	@Test public void testOneCopybook() throws UnsupportedEncodingException, XMLStreamException, FactoryConfigurationError, IOException {
		int idx = 6;
	...
	private void checkCobolIoBuilder(String cpy, boolean hasConds, ICobolIOBuilder iob1, int fs, String xmlstr)
		...
		assertEquals(xmlString1, xmlString2, cpy);
...
//				assertEquals(xFields1[i].getDependOnDtls().firstIdx, xFields2[i].getDependOnDtls().firstIdx);
		...
		for (int i = 0; i < size; i++) {
			...
			assertEquals( xFields1[i].getDecimal(), field1.getDecimal(), xFields1[i].getName());
			assertEquals( xFields1[i].getGroup(),  field1.getGroupName(), xFields1[i].getName());
	...
	@Test public void testSignClause() throws UnsupportedEncodingException, XMLStreamException, FactoryConfigurationError, IOException {
	...
	@Test public void testUsage() throws UnsupportedEncodingException, XMLStreamException, FactoryConfigurationError, IOException {
	...
	@Test public void testJustified() throws UnsupportedEncodingException, XMLStreamException, FactoryConfigurationError, IOException {		
	...
	@Test public void testDecimal() throws UnsupportedEncodingException, XMLStreamException, FactoryConfigurationError, IOException {		
	...
	@Test public void testNum() throws UnsupportedEncodingException, XMLStreamException, FactoryConfigurationError, IOException {		
...
//	};
//	
//	@Test public void testFillerAtEnd() throws UnsupportedEncodingException, XMLStreamException, FactoryConfigurationError, IOException {		
...
//	}
	...
	@Test public void testFillerAtEnd1() throws UnsupportedEncodingException, XMLStreamException, FactoryConfigurationError, IOException {
	...
	@Test public void testOptions() throws UnsupportedEncodingException, XMLStreamException, FactoryConfigurationError, IOException {
		CpyOptions[] opts = {
...
//	}
	...
	private void checkLayoutFields(FieldDetail[] expectedFields, ICobolIOBuilder iob, String cpy) throws IOException {
		...
		if (expectedFields != null) {
			assertEquals( expectedFields.length, size, cpy);
			for (int i = 0; i < size; i++) {
