 ...
 *
 */
public class TstXmlSchemaCalcPosLength  {
 ...
 * -----------------------------------------------------------------------------------------------
 */
	@Test public void testPosLengthCalculation01() throws IOException {
		int i =0;
	...
	@Test public void testPosLengthCalculation02() throws IOException {
		int i =0;
	...
	@Test public void testPosLengthCalculation02b() throws IOException {
		int i =0;
		for (String cpy : DTAR020_XML_2) {
			LayoutDetail l = JRecordInterface1.SCHEMA_XML
					.newIOBuilder(new ByteArrayInputStream(cpy.getBytes()), "DTAR020")
	...
	@Test public void testPosLengthCalculation02c() throws IOException {
		int i =0;
	...
	@Test public void testDefaultCharSet1() throws IOException {
		LayoutDetail l = JRecordInterface1.SCHEMA_XML
	...
	@Test public void testDefaultCharSet2() throws IOException {
		RecordEditorXmlLoader loader = new RecordEditorXmlLoader();
	...
	@Test public void testPosCalculationCsv01() throws IOException {
		int i =0;
