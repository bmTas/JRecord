 ...
 *
 */
public class TestTypeUpdates extends JUnit3Test   {

	@Test public void testTypesStandardCharset() throws Exception {
		tstFile(Conversion.DEFAULT_ASCII_CHARSET);
	}

	@Test public void testTypesCP037() throws Exception {
		tstFile("CP037");
	}
	

	@Test public void testTypesCP273() throws Exception {
		tstFile("CP273");
	}
	...
	private void tstFile(String charset) throws Exception {
		...
		try {
			while ((inLine = r.read()) != null) {
				...
				assertEqualsV3o(num + " Type 1: " + fld.getType(), inLine.getFieldValue(td.testResultHex).asString(), fieldValue.asHex());
