 ...
 *
 */
public class TstArrayChecks extends JUnit3Test  {
	...
	@Test public void testStopSpaces01() throws IOException {
	...
	@Test public void testSkipSpaces01() throws IOException {
	...
	@Test public void testStopSpacesZero01() throws IOException {
	...
	@Test public void testSkipSpacesZero01() throws IOException {
	...
	@Test public void testLowValues() throws IOException {
	...
	@Test public void testHighValues() throws IOException {
	...
	@Test public void testVarCheck() throws IOException {
	...
	private void tstForAllIndexs(IArrayItemCheck check, int expectedResult,
		...
		for (int j = 0; j <= end; j++) {
			...
			if (i == j && i < 8) {
				assertEqualsV3i(i + ", " + j, expectedResult, r);
			} else {
				assertEqualsV3i(i + ", " + j, IArrayItemCheck.R_PROCESS, r);
			}
		}
	}
