...
public class TstArrayFieldDefinition extends JUnit3Test  {
	...
	@Test public void test01dim() throws IOException  {
	...
	@Test public void test02dim() throws IOException  {
	...
	@Test public void test03dim() throws IOException  {
	...
	private void checkFld(String fldName, String idx, int pos, int len, IFieldDetail fld) {
		...
		assertEqualsV3i("Idx: " + idx, pos, fld.getPos());			
		assertEqualsV3i("Idx: " + idx, len, fld.getLen());
	}
