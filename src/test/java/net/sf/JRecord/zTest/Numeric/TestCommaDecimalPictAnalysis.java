...
public class TestCommaDecimalPictAnalysis  {
	...
	@Test public void testNumericPictures() {
	...
	@Test public void testNumericCompPictures() {
...
//		chkCompPict("-5", "9999V99",Type.ftBinaryBigEndianPositive);
	...
	private void chkPict(String picture, int type) {
		assertEquals( type, bc.getTypeIdentifier("", picture, false, false, ""), "Checking: " + picture);
	}


	private void chkCompPict(String compId, String picture, int type) {
		assertEquals( type, bc.getTypeIdentifier(Cb2xmlConstants.COMP + compId, picture, false, false, ""),
				"Checking: " + picture);
	}
}
