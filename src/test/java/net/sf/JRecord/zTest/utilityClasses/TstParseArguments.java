...
public class TstParseArguments extends JUnit3Test  {
	...
	@Test public void testGetArgString() {
	...
	private void chkGetArgStr(ParseArguments pa) {
		...
		assertTrueV3("Expecting null, not >" + s, s == null);
	}

	@Test public void testGet2Args() {
	...
	@Test public void testGetArgStringString() {
	...
	@Test public void testGetArgList() {
	...
	private void chkGetArgList(ParseArguments pa) {
		...
		assertTrueV3("Expecting null, not >" + l, l == null || l.size() == 0);
	}
