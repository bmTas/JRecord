 ...
 *
 */
public class TstByteIoProvider  {
	...
	@Test public void testIoProviderReaders() {
        ...
        for (int i = 0; i < ioIds.length; i++) {
            ...
            assertEquals(
                    ...
                    "Error Reader " + ioIds[i]);
        }
    }


    @Test public void testIoProviderWriters1() {
            ...
            assertEquals(
                    ...
                    ByteIOProvider.getInstance()
                    	.getByteWriter(ioIds[i])
                    		.getClass(),
                   "Error Writer " + ioIds[i]);
        }
    }

    

    @Test public void testIoProviderWriters2() {
