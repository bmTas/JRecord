...
public class TstBinTextWriter  {
    ...
    @Test public void testMac() throws IOException {
    	System.out.println("--- Testing Mac File ");
    	tstAFile(Constants.LF_BYTES);
    }

    @Test public void testLinux() throws IOException {
       	System.out.println("--- Testing Linux File ");
    	tstAFile(Constants.CR_BYTES);
    }

    @Test public void testWindows() throws IOException {
