 ...
 *
 */
public class TstRecordFujitsuVbIOReader  {
...
//    }
    ...
    @Test public void testBinReadDtar0020() throws Exception {
    ...
    @Test public void testBinReadCombined() throws Exception {
    ...
    @Test public void testBinReadFutjisu() throws Exception {
    ...
    throws IOException {
        ...
        while ((line = tReader.read()) != null) {
            ...
            if (!b) {
                ...
                assertTrue(b, id + "Bin Line " + i + " is not correct ");
            }
            i += 1;
        }

        assertEquals(lines2Test.length, i,
        		id + "Expected to read " + lines2Test.length
                   + " got " + i);
