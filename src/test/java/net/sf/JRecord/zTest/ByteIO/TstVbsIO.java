...
public class TstVbsIO {
	...
	public void tstJoin(byte[][] byteLines) {
		...
		for (int i = 0; i < byteLines.length; i++) {
			...
			for (int j = 0; j < bj.length; j++) {
				assertEquals(j, bj[j], i + ",  " + j);
			}
		}
	}
	
	@Test public void testRead1a() throws IOException {
		tstRead1(byteLines1);
	}
	
	@Test public void testRead1b() throws IOException {
		tstRead1(byteLines2);
	}

	@Test public void testRead1c() throws IOException {
		tstRead1(byteLines3);
	}
	...
	@Test public void testRead3() throws IOException {
		Data data = new Data();
	...
	@Test public void testRead4() throws IOException {
		Data data = new Data();
	...
	private static class Data {
		...
		void check() throws IOException {
			...
			while ((line = rr.read()) != null) {
				...
				assertTrue(ok, i + ", " + rawData.get(i).size());
