...
public class TstCobol1  {
	...
	@Test public void testPositiveConversion() throws RecordException {
	...
	public void testPositiveConversion(int cobolDialect, int[] types) throws RecordException {
		...
		for (int i = 0; i < l.getRecord(0).getFieldCount(); i++) {
			...
			assertTrue(t instanceof TypeNum && ((TypeNum) t).isPositive(), "Field: " + field.getName());
			assertEquals(types[i], field.getType(), "Index: " + i);
		}
	...
	@SuppressWarnings("deprecation")
	@Test public void testSignedConversion() throws RecordException {
	...
	public void testSignedConversion(int cobolDialect, int[] types) throws RecordException {
		...
		for (int i = 0; i < l.getRecord(0).getFieldCount(); i++) {
			...
			assertTrue((t instanceof TypeNum && (! ((TypeNum) t).isPositive())), "Field: " + field.getName());
			assertEquals(types[i], field.getType(), "Field Type: " + field.getName() + " " + cobolDialect);
		}
