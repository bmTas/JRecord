...
public class TstCobolIoBuilderIO  {
	...
	@Test public void testDTAR020SchemaLoad1a() throws RecordException, IOException {
	...
	@Test public void testDTAR020SchemaLoad1b() throws RecordException, IOException {
...
//				);
	...
	@Test public void testDTAR020SchemaLoad2a() throws RecordException, IOException {
		ICobolIOBuilder ioBuilder = CobolIoProvider.getInstance()
				.newIOBuilder(new ByteArrayInputStream(COPBOOK_BYTES), "DTAR020");
	...
	@Test public void testDTAR020SchemaLoad2b() throws RecordException, IOException {
		ICobolIOBuilder ioBuilder =JRecordInterface1.COBOL
				.newIOBuilder(new ByteArrayInputStream(COPBOOK_BYTES), "DTAR020");
		tstDTAR020SchemaLoad2(ioBuilder);
   }
	 ...
	 */
	@Test public void testReader1() throws FileNotFoundException, IOException, RecordException {
		ICobolIOBuilder ioBuilder = CobolIoProvider.getInstance()
										.newIOBuilder(new ByteArrayInputStream(COPBOOK_BYTES), "DTAR020")
	 ...
	 * Check Reading a File / Stream with an IOBuilder
	 */
	@Test public void testReader2() throws FileNotFoundException, IOException, RecordException {
		ICobolIOBuilder ioBuilder = JRecordInterface1.COBOL
										.newIOBuilder(new ByteArrayInputStream(COPBOOK_BYTES), "DTAR020")
											.setFileOrganization(Constants.IO_FIXED_LENGTH)
											.setFont("CP037");
	...
	@Test public void testReader3() throws FileNotFoundException, IOException, RecordException {
	 ...
	 */
	@Test public void testFixedWriter1() throws IOException, RecordException {
		ICobolIOBuilder ioBuilder = CobolIoProvider.getInstance()
				.newIOBuilder(new ByteArrayInputStream(COPBOOK_BYTES), "DTAR020")
					.setFileOrganization(Constants.IO_FIXED_LENGTH)
					.setFont("CP037");
	 ...
	 * Check writing a Fixed Width Records to  Filename and a Stream
	 */
	@Test public void testFixedWriter2() throws IOException, RecordException {
		ICobolIOBuilder ioBuilder = JRecordInterface1.COBOL
				.newIOBuilder(new ByteArrayInputStream(COPBOOK_BYTES), "DTAR020")
					.setFileOrganization(Constants.IO_FIXED_LENGTH)
					.setFont("CP037");
	...
	@Test public void testFixedWriter3() throws IOException, RecordException {
	 ...
	 */
	@Test public void testVBWriter1() throws IOException, RecordException {
		ICobolIOBuilder ioBuilder = CobolIoProvider.getInstance()
				.newIOBuilder(new ByteArrayInputStream(COPBOOK_BYTES), "DTAR020");
	 ...
	 * Check writing Mainframe VB Records to both a Filename and a Stream
	 */
	@Test public void testVBWriter2() throws IOException, RecordException {
		ICobolIOBuilder ioBuilder = JRecordInterface1.COBOL
				.newIOBuilder(new ByteArrayInputStream(COPBOOK_BYTES), "DTAR020");
		tstVBWriter(ioBuilder);
	}
	...
	private void tstVBWriter(ICobolIOBuilder ioBuilder) throws IOException,
		...
		for (int i = 0; i < lines.size(); i++) {
			...
			assertTrue( Arrays.equals(lines.get(i).getData(), rec), "Testing Line: " + i);
	 ...
	 */
	@Test public void testGnuCobolVBWriter1() throws IOException, RecordException {
		ICobolIOBuilder ioBuilder = CobolIoProvider.getInstance()
				.newIOBuilder(new ByteArrayInputStream(COPBOOK_BYTES), "DTAR020");
		tstGnuCobolVBWriter(ioBuilder);
	}
	
	@Test public void testGnuCobolVBWriter2() throws IOException, RecordException {
		ICobolIOBuilder ioBuilder = JRecordInterface1.COBOL
				.newIOBuilder(new ByteArrayInputStream(COPBOOK_BYTES), "DTAR020");
		tstGnuCobolVBWriter(ioBuilder);
	}
	...
	private void tstReader(AbstractLineReader r) throws IOException {
		...
		while ((line = r.read()) != null) {
			for (int i = 0; i <rec.getFieldCount(); i++) {
				assertEquals(
						EXPECTED[lineNo][i], line.getFieldValue(0, i).asString(),
						"Line=" + lineNo + ", Field=" + rec.getField(i).getName());
			}
			lineNo+=1;
		}
		r.close();
