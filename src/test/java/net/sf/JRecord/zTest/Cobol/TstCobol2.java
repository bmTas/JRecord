...
public class TstCobol2  {
	...
	@Test public void testBlankConversion() throws RecordException {
	...
	@Test public void testMixedConversion() throws RecordException {
	...
	@Test public void testFillerConversion() throws RecordException {
	...
	public void testConversion(int cobolDialect, int[][] fields, String[] names, String copybook, boolean differentLengths) throws RecordException {
		...
		for (int i = 0; i < l.getRecord(0).getFieldCount(); i++) {
			...
			assertEquals(names[i], field.getName(), "Field Name: ");
			assertEquals(fields[i][0], field.getPos(), "Field Position: ");
			assertEquals(fields[i][1], field.getLen(), "Field Length: ");
			assertEquals(fields[i][2], field.getType(), "Field Type: ");
		}
