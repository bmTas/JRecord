...
public class TstSignSeperate  {
	...
	@Test public void testDecimal0() throws IOException {
		tstSignSeperate(COPYBOOK0, 0);
	}
	
	@Test public void testDecimal1() throws IOException {
		tstSignSeperate(COPYBOOK1, 1);
	}
	
	@Test public void testDecimal2() throws IOException {
		tstSignSeperate(COPYBOOK2, 2);
	}
	
	@Test public void testDecimal0a() throws IOException {
		tstSignSeperate(EN_SIGN_TRAILING_0, 0);
		tstSignSeperate(EN_SIGN_TRAILING_0p, 0);
	}
	
	@Test public void testDecimal1a() throws IOException {
		tstSignSeperate(EN_SIGN_TRAILING_1, 1);
		tstSignSeperate(EN_SIGN_TRAILING_1p, 1);
		tstSignSeperateAD(EN_SIGN_TRAILING_1d, 1);
	}
	
	@Test public void testDecimal2a() throws IOException {
	...
	public void chk(AbstractLine l, int i, String value, String s) {
		...
		assertEquals( s, l.getFullLine(), i + "");
		
		l.setData(s);		
		assertEquals( value, l.getFieldValue(0, 0).asString(), i + "");
	}
