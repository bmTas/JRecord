 ...
 *
 */
public class TstCobolIOBuilderKeepFiller  {
	...
	@Test public void testKeepFiller01() throws IOException {
	...
	@Test public void testDropFiller01() throws IOException {
	...
	@Test public void testDropFiller02() throws IOException {
		FieldDetail[] expected = new FieldDetail[EXPECTED_1.length / 2 + 1];
		@SuppressWarnings("deprecation")
		ICobolIOBuilder bldr = JRecordInterface1.COBOL
					.newIOBuilder(new StringReader(COPYBOOK_WITH_FILLERS_1), "Tst-Record")
	...
	@Test public void testKeepFiller03() throws IOException {
		@SuppressWarnings("deprecation")
		ICobolIOBuilder bldr = JRecordInterface1.COBOL
	...
	@Test public void testDropFiller03() throws IOException {
		FieldDetail[] expected = new FieldDetail[EXPECTED_1.length / 2 + 1];
	...
	@Test public void testDropFiller04() throws IOException {
		FieldDetail[] expected = new FieldDetail[EXPECTED_1.length / 2 + 1];
		@SuppressWarnings("deprecation")
		ICobolIOBuilder bldr = JRecordInterface1.COBOL
					.newIOBuilder(new StringReader(COPYBOOK_WITH_FILLERS_2), "Tst-Record")
	...
	@Test public void testKeepFiller11() throws IOException {
	...
	@Test public void testDropFiller12() throws IOException {
	...
	@Test public void testKeepFiller14() throws IOException {
	...
	@Test public void testDropFiller14() throws IOException {
