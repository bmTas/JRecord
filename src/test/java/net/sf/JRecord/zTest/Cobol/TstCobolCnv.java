...
public class TstCobolCnv  {
	...
	@Test public void testGet1() throws IOException {
		chkSignTrailing(getIOBuilder());
	}

	@Test public void testGet2() throws IOException {
	...
	private void chkSignTrailing(ICobolIOBuilder iob) throws IOException {
		...
		assertEquals(Type.ftSignSeparateTrail, fieldDef.getType(), fieldValue.getTypeName());
	...
	@Test public void testGet3() throws IOException {
		chkSignLeading(getIOBuilder3());
	}

	@Test public void testGet4() throws IOException {
	...
	@Test public void testGet5() throws IOException {
		chkTrailingDot(getIOBuilder5());
	}

	@Test public void testGet6() throws IOException {
	...
	private void chkTrailingDot(ICobolIOBuilder iob) throws IOException {
		...
		assertEquals(Type.ftSignSepTrailActualDecimal, fieldDef.getType(), fieldValue.getTypeName());
		assertEquals(1, fieldDef.getPos());
	...
	@Test public void testGet7() throws IOException {
		chkLeadingDot(getIOBuilder7());
	}


	@Test public void testGet8() throws IOException {
...
//		assertEquals(Type.ftSignSeparateTrail, fieldDef.getType());
	...
	@Test public void testGet9() throws IOException {
	...
	@Test public void testSet1() throws IOException {
	...
	private void chkSet1(ICobolIOBuilder iob) throws IOException {
		...
		assertEquals( "012345+", line.getFullLine(), fieldValue.getTypeName());
		fieldValue.set("+123.45");
	...
	@Test public void testSet3() throws IOException {
	...
	@Test public void testSet5() throws IOException {
	...
	private void chkSet5(ICobolIOBuilder iob) throws IOException {
		...
		fieldValue.set("123.45");
		assertEquals( "0123.45+", line.getFullLine(), fieldValue.getTypeName());
		fieldValue.set("+123.45");
	...
	@Test public void testSet7() throws IOException {
	...
	@Test public void testSet9() throws IOException {
		ICobolIOBuilder iob = getIOBuilder9();
		AbstractLine line = iob.newLine();
		AbstractFieldValue fieldValue = line.getFieldValue(0, 0);
	...
	@Test public void testSetGet() throws IOException {
		String[] copybooks = {
	...
	@Test public void testSetGet9() throws IOException {
		ICobolIOBuilder iob = getIOBuilder9();
		AbstractLine line = iob.newLine();
		AbstractFieldValue fieldValue = line.getFieldValue(0, 0);
	...
	private void getSet(String id, AbstractFieldValue fieldValue, String value) {
		...
		assertEquals( value, fieldValue.asString(), id);
	}
