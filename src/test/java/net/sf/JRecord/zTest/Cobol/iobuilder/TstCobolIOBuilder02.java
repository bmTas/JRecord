...
public class TstCobolIOBuilder02  {
...
//			createField("pcomp-fld-4", 23, 2, Type.ftBinaryBigEndianPositive),
	...
	@Test public void testRightJustified2() throws IOException {
	...
	@Test public void test01c() throws IOException {
		tstMainframe(getIOBuilderFromCb2xmlCopybook(), false);
	}

	
	@Test public void test02c() throws IOException {
		tstMainframe(getIOBuilderFromCb2xmlCopybook(), true);
	}
	
	@Test public void test21() throws IOException {
		tst(getStreamIOBuilder(), false);
	}
	
	
	@Test public void test22() throws IOException {
		tst(getStreamIOBuilder(), true);
	}

	
	@Test public void test23() throws IOException {
		streamIoBuilder = null;
		tst(getStreamIOBuilder(), true);
	}
	
	@Test public void test31() throws IOException {
		tst(getReaderIOBuilder(), false);
	}
	
	
	@Test public void test32() throws IOException {
		tst(getReaderIOBuilder(), true);
	}

	
	@Test public void test33() throws IOException {
		readerIoBuilder = null;
		tst(getReaderIOBuilder(), true);
	}
	@Test public void testRecordDecider() throws IOException {
