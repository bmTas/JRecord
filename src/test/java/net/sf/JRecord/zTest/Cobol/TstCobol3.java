...
public class TstCobol3  {
	...
	@Test public void testCblUnSigned() throws IOException {
		tstSetUnsigned("");
		tstSetUnsigned("CP037");
	}


	@Test public void testCblSigned() throws IOException {
		tstSetSigned("");
		tstSetSigned("CP037");
	}
	/**
	...
	private void tstFieldValue(AbstractLine line, int i, IFieldValue fieldValue) {
		...
		assertEquals("" + i, line.getField("f01").toString(), "Check Field");
	}
