 ...
 *
 */
public class TstOccursDepending42  {
	...
	@Test public void testPositionCalc3() throws Exception {
		try {
	...
	@Test public void testPositionCalc4() throws Exception {
		try {
...
//	}
	...
	private int check(AbstractLine line, IFieldDetail fld, int pos) throws RecordException {
		...
		if (pos != calculatedPosition) {
			...
			assertEquals( pos, calculatedPosition, id);
		}
