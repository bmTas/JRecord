...
public class TstReadingWriting60  {
	
	@Test public void test01()  throws IOException, RecordException {
		tst("OccursDepending1.cbl", Constants.IO_STANDARD_TEXT_FILE);
	}
	
	@Test public void test02()  throws IOException, RecordException {
		tst("OccursDepending1.cbl", Constants.IO_VB);
	}
	
	@Test public void test03()  throws IOException, RecordException {
		tst("OccursDepending1.cbl", Constants.IO_STANDARD_UNICODE_TEXT_FILE);
	}
	
	@Test public void test04()  throws IOException, RecordException {
		tst("OccursDepending2.cbl", Constants.IO_STANDARD_TEXT_FILE);
	}
	
	@Test public void test05()  throws IOException, RecordException {
		tst("OccursDepending2.cbl", Constants.IO_VB_FUJITSU);
	}
	
	@Test public void test06()  throws IOException, RecordException {
		tstSales("OccursDepending3.cbl", Constants.IO_VB, true);
	}

	
	@Test public void test07()  throws IOException, RecordException {
		tstSales("OccursDepending4.cbl", Constants.IO_VB, true);
	}
	
	
	@Test public void test08()  throws IOException, RecordException {
