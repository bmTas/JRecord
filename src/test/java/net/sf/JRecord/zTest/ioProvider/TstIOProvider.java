 ...
 *
 */
public class TstIOProvider extends JUnit3Test  {
	...
	@Test public void testGetReader1() {
	...
	@Test public void testGetReader2() {
		LineIOProvider iop = LineIOProvider.getInstance();
	...
	@SuppressWarnings("deprecation")
	@Test public void testGetWriter1() {
		LineIOProvider iop = LineIOProvider.getInstance();
	...
	@Test public void testGetWriter2() {
		LineIOProvider iop = LineIOProvider.getInstance();
	...
	private void chkClass(String msg, Class class1, Class class2) {
		assertEqualsV3o(msg, class1, class2);
