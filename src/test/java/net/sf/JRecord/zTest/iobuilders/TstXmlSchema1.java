...
public class TstXmlSchema1  {
    ...
    @Test public void testDTAR020SchemaLoad() throws RecordException, IOException {
...
//			);
    ...
    @Test public void testDTAR020Read() throws RecordException, IOException {
    	 ...
    	 while ((l = reader.read()) != null) {
    		 ...
    		 for (AbstractFieldValue fv : fieldIterator) {
    			assertEquals(EXPECTED_DTAR020_DATA[i][j++], fv.asString(), i + ", " + j); 
    		 }
    ...
    @Test public void testAmsPOSchemaLoad() throws RecordException, IOException {
