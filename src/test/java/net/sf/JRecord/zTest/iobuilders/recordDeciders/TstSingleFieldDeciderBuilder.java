 ...
 *
 */
public class TstSingleFieldDeciderBuilder extends JUnit3Test  {
	...
	@Test public void testSmallCaseSensitive() throws IOException {
	...
	@Test public void testLargeCaseSensitive() throws IOException {
		tstDeciderBldr(new CommonDeciderCode.SfDeciderBldr(CommonDeciderCode.DeciderType.LARGE_DECIDER));
	}


	@Test public void testJRec1() throws IOException {
		tstDeciderBldr(new CommonDeciderCode.JrDeciderBldr(true));
		tstDeciderBldr(new CommonDeciderCode.JrDeciderBldr(false));
	}
	
	@Test public void testJRec2() throws IOException {
		...
		assertTrueV3(decider.getClass().getName(), decider instanceof SingleFieldDecider.SmallDecider);
		...
		assertTrueV3(decider.getClass().getName(), decider instanceof SingleFieldDecider.LargeDecider);
		assertTrue(jrDeciderBldr.getType() == CommonDeciderCode.DeciderType.LARGE_DECIDER);
	}

	
	@Test public void testJRec2CaseSensitive() throws IOException {
	...
	public void tstDeciderBuilder(CommonDeciderCode.ISfDeciderBldr deciderBldr, CommonDeciderCode tst,
		...
		for (SelValue val : tstValues) {
			...
			assertEqualsV3o(val.val + " ~ " + val.record, 
					val.record, 
