...
public class TstCsvWrite  extends JUnit3Test  {
	...
	@Test public void testCsvParser0()  throws Exception{
	...
	@Test public void testCsvParser1()  throws Exception{
	...
	@Test public void testCsvParser2()  throws Exception{
	...
	@Test public void testCsvParser3()  throws Exception{
	...
	@Test public void testCsvParser4()  throws Exception{
	...
	@Test public void testCsvParser5()  throws Exception{
	...
	@Test public void testCsvParser10()  throws Exception{
		useLine = false;
		writeFile(TstConstants.TEMP_DIRECTORY + "CsvFile0.txt", "0", "Char", false);
		writeFile(TstConstants.TEMP_DIRECTORY + "CsvFile0n.txt", "0", "Char", true);
	}
	...
	@Test public void testCsvParser11()  throws Exception{
		useLine = false;
		writeFile(TstConstants.TEMP_DIRECTORY + "CsvFile1.txt", "1", "Char", false);
		writeFile(TstConstants.TEMP_DIRECTORY + "CsvFile1n.txt", "1", "Char", true);
	}
	...
	@Test public void testCsvParser12()  throws Exception{
		useLine = false;
		writeFile(TstConstants.TEMP_DIRECTORY + "CsvFile2a.txt", "2", "Char", false);
	...
	@Test public void testCsvParser13()  throws Exception{
		useLine = false;
		writeFile(TstConstants.TEMP_DIRECTORY + "CsvFile3.txt", "3", "Char", false);
		writeFile(TstConstants.TEMP_DIRECTORY + "CsvFile3n.txt", "3", "Char", true);
	}
	...
	@Test public void testCsvParser14()  throws Exception{
		useLine = false;
		writeFile(TstConstants.TEMP_DIRECTORY + "CsvFile4.txt", "4", "Char", false);
		writeFile(TstConstants.TEMP_DIRECTORY + "CsvFile4n.txt", "4", "Char", true);
	}
	...
	@Test public void testCsvParser15()  throws Exception{
		useLine = false;
		writeFile(TstConstants.TEMP_DIRECTORY + "CsvFile5a.txt", "5", "Char", false);
