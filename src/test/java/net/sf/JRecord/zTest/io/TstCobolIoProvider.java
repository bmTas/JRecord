...
public class TstCobolIoProvider  {
	 ...
	 * @throws Exception
	 */
	@Test public void testGetReader1() throws Exception {
	 ...
	 * @throws Exception
	 */
	@Test public void testGetReader2() throws Exception {
		CobolIoProvider ioProvider = CobolIoProvider.getInstance();
	...
	@Test public void testGetWriter1() throws Exception {
		CobolIoProvider ioProvider = CobolIoProvider.getInstance();
	 ...
	 * @throws Exception
	 */
	@Test public void testGetWriter2() throws Exception {
		CobolIoProvider ioProvider = CobolIoProvider.getInstance();
