...
public class TstCharReader3  {
	...
	@Test public void testStdCr() throws IOException {

		doFontCrTest("StdLine", "", new StdLine());
	}

	@Test public void testStdCrCp037() throws IOException {

		doFontCrTest("StdLine cp037 ", "cp037", new StdLine());
	}


	@Test public void testStdCrUtf8() throws IOException {

		doFontCrTest("StdLine utf-8 ", "utf-8", new StdLine());
	}


	@Test public void testStdCrUtf16() throws IOException {

		doFontCrTest("StdLine utf-16 ", "utf-16", new StdLine());
	}


	@Test public void testCsvStdCr() throws IOException {

		doCsvFontCrTest("Embedded Cr", "");
	}


	@Test public void testCsvStdCrCp037() throws IOException {

		doCsvFontCrTest("Embedded Cr cp037", "cp037");
	}


	@Test public void testCsvStdCrUtf8() throws IOException {

		doCsvFontCrTest("Embedded Cr utf-8", "utf-8");
	}


	@Test public void testCsvStdCrUtf16() throws IOException {
...
//		System.out.println(" -------------- ");
	...
	throws IOException {
		...
		while ((b = r.read()) != null) {
			assertEquals( fl.formatLine(i), b, id + ": " + i);
			i += 1;
		}
		r.close();
	}
