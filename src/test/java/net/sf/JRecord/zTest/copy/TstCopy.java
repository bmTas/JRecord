...
public class TstCopy  {
	...
	private static final String DTAR020_DATA_FILE_NAME = TstCopy.class.getResource("DTAR020.bin").getFile();  
	private static final String DTAR020_COPBOOK_FILE_NAME = TstCopy.class.getResource("DTAR020.cbl").getFile();  
	...
	@Test public void testCopyFileByMatchingFieldNames1() throws Exception, RecordException {
	...
	@Test public void testCopyFileByMatchingFieldNames2() throws Exception, RecordException {
	...
	@Test public void testCopyFileByMatchingFieldNamesCsv1() throws Exception, RecordException {
		CommonBits.setUseCsvLine(false);
		doTest( getCsvSchema(), true);
	}

	
	@Test public void testCopyFileByMatchingFieldNamesCsv2() throws Exception, RecordException {
		CommonBits.setUseCsvLine(false);
	...
	@Test public void testCopyFileByMatchingFieldNamesCsv3() throws Exception, RecordException {
		CommonBits.setUseCsvLine(true);
		doTest( getCsvSchema(), true);
	}

	
	@Test public void testCopyFileByMatchingFieldNamesCsv4() throws Exception, RecordException {
		CommonBits.setUseCsvLine(true);
		LayoutDetail outSchema = getCsvSchemaReverse();
	...
	@Test public void testCsvCopy1() throws Exception, RecordException {
		CommonBits.setUseCsvLine(false);
		tstCsvCopy1();
	}

	
	@Test public void testCsvCopy2() throws Exception, RecordException {
		CommonBits.setUseCsvLine(true);
		tstCsvCopy1();
	}

	
	@Test public void testCsvCopy3() throws Exception, RecordException {
		CommonBits.setUseCsvLine(true);
		tstCsvCopy3();
	}
		...
		for (int i = 0; i < m; i++) {
			for (int j = 0; j < fieldCount; j++) {
				assertEquals(
						...
						id + " " + i + ", " + j + ", " + Math.abs(j - sub));
			}
		}
		assertEquals( l1.size(), l2.size(), id);
		assertEquals( fieldCount, l2.get(0).getLayout().getRecord(0).getFieldCount(), id);
	}
