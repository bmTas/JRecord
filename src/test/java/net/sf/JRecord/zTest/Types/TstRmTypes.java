...
public class TstRmTypes  extends JUnit3Test   {
	...
	@Test public void testRmPosiveGet() {
		...
		assertEqualsV3o(" 1 GetValue - Field1 ", "12345",  type.getField(record1, fld1.getPos(), fld1).toString());
		assertEqualsV3o(" 2 GetValue - Field2 ", "123.45", type.getField(record1, fld2.getPos(), fld2).toString());
		
		assertEqualsV3o(" 3 GetValue - Field1 ", "23456",  type.getField(record2, fld1.getPos(), fld1).toString());
		assertEqualsV3o(" 4 GetValue - Field2 ", "234.56", type.getField(record2, fld2.getPos(), fld2).toString());
		
		assertEqualsV3o(" 5 GetValue - Field1 ", "23450",  type.getField(record3, fld1.getPos(), fld1).toString());
		assertEqualsV3o(" 6 GetValue - Field2 ", "234.50", type.getField(record3, fld2.getPos(), fld2).toString());
	}
		
	
	@Test public void testRmGet() {
		...
		assertEqualsV3o(" 1  GetValue - Field1 ", "1234",  type.getField(record11, fld1.getPos(), fld1).toString());
		assertEqualsV3o(" 2  GetValue - Field2 ", "12.34", type.getField(record11, fld2.getPos(), fld2).toString());
		
		assertEqualsV3o(" 3  GetValue - Field1 ", "2345",  type.getField(record21, fld1.getPos(), fld1).toString());
		assertEqualsV3o(" 4  GetValue - Field2 ", "23.45", type.getField(record21, fld2.getPos(), fld2).toString());
		
		assertEqualsV3o(" 5  GetValue - Field1 ", "2345",  type.getField(record31, fld1.getPos(), fld1).toString());
		assertEqualsV3o(" 6  GetValue - Field2 ", "23.45", type.getField(record31, fld2.getPos(), fld2).toString());

		assertEqualsV3o(" 7  GetValue - Field1 ", "-1234",  type.getField(record12, fld1.getPos(), fld1).toString());
		assertEqualsV3o(" 8  GetValue - Field2 ", "-12.34", type.getField(record12, fld2.getPos(), fld2).toString());
		
		assertEqualsV3o(" 9  GetValue - Field1 ", "-2345",  type.getField(record22, fld1.getPos(), fld1).toString());
		assertEqualsV3o(" 10 GetValue - Field2 ", "-23.45", type.getField(record22, fld2.getPos(), fld2).toString());

	}
	
	@Test public void testRmPosiveSet() throws Exception {
		TypeRmCompPositive type = new TypeRmCompPositive();
	...
	@Test public void testRmSet() throws Exception {
		TypeRmComp type = new TypeRmComp();
