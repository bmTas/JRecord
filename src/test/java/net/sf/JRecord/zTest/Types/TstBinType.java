...
//        ,  49,  50, -64, -63,-125,   0,   0 ,  13,  10 };
    ...
    private static FieldDetail fldChar, fldCharRightJust, fldDecimal, fldDouble,
    ...
    private static FieldDetail getType(int pos, int len, int type, int decimal) {
    ...
    @Test public void testGetValue() {
        ...
        assertEqualsXX(" 1 GetValue - Character Field ", "asdf", getFldValue(fldChar));
        assertEqualsXX(" 2 GetValue - Character Field ", "    qwerty", getFldValue(fldCharRightJust));
        assertEqualsXX(" 3 GetValue - Decimal Field ", "123", getFldValue(fldDecimal));
        assertEqualsXX(" 4 GetValue - Double Field ", "121.232", getFldValue(fldDouble));
        assertEqualsXX(" 5 GetValue - Float  Field ", "232.343", getFldValue(fldFloat));
        assertEqualsXX(" 6 GetValue - Num  Field ", "3456", getFldValue(fldNum));
        assertEqualsXX(" 7 GetValue - Num Right Just", "123", getFldValue(fldNumRightJust));
        assertEqualsXX(" 8 GetValue - Num Zero Padded Field ", "456", getFldValue(fldNumZeroPadded));
        assertEqualsXX(" 9 GetValue - Postive Int ", "789", getFldValue(fldPostiveInt));
        assertEqualsXX("10 GetValue - Assumed Decimal ", "123.4500", getFldValue(fldAssummedDecimal));
        assertEqualsXX("11 GetValue - Num 2 Decimal ", "23.67", getFldValue(fldNum2decimal));
        assertEqualsXX("12 GetValue - Decimal ", "45.67", getFldValue(fldDecimal2digits));
        assertEqualsXX("13 GetValue - Positive Int ", "123.45", getFldValue(fldPositiveInt2digit));

        assertEqualsXX("14 GetValue - Num 2 Decimal Digits ", "234.56", getFldValue(fldNum2decimal1));
        assertEqualsXX("15 GetValue - Mainframe Binary ", "321", getFldValue(fldMainframeInt));
        assertEqualsXX("16 GetValue - Mainframe Binary with Decimal",
                "4000000.00", getFldValue(fldMainframeInt2decimal));
        assertEqualsXX("17 GetValue - Byte ", "127", getFldValue(fldByte));
        assertEqualsXX("18 GetValue - Small Int ", "31000", getFldValue(fldSmallInt));
        assertEqualsXX("19 GetValue - Int ", "1000000000", getFldValue(fldInt));
        assertEqualsXX("20 GetValue - Long ", "100000000000000000", getFldValue(fldLong));
        assertEqualsXX("21 GetValue - Mainframe Small Int ", "31000",
                getFldValue(fldMainframeSmallInt));
        assertEqualsXX("22 GetValue - Mainframe Long ",
                "100000000000000000", getFldValue(fldMainframeLong));
        assertEqualsXX("23 GetValue - Mainframe Packed ", "1234",
                getFldValue(fldMainframePackedDecimal));
        assertEqualsXX("24 GetValue - Mainframe Packed with decimal",
                "123.0", getFldValue(fldMainframePackedwithDecimal));

        assertEqualsXX("25 GetValue - Mainframe Zoned ", "-12", getFldValue(fldZoned));
        assertEqualsXX("26 GetValue - Mainframe Zoned with decimal",
                "-0.12", getFldValue(fldZonedWithDecimal));

        assertEqualsXX("27 GetValue - Bit 1byte ", "10000000", getFldValue(fldBit1));
        assertEqualsXX("28 GetValue - Bit 2byte ", "1000000110000011", getFldValue(fldBit2));
    }
    ...
    @Test public void testGetValue1() {
        ...
        assertEqualsXX(" 1 GetValue - Character Field ", "asdf", getFldValue(fldChar));
        assertEqualsXX(" 2 GetValue - Character Field ", "    qwerty", getFldValue(fldCharRightJust));
        assertEqualsXX(" 3 GetValue - Decimal Field ", "233", getFldValue(fldDecimal));
        assertEqualsXX(" 4 GetValue - Double Field ", "-121.232", getFldValue(fldDouble));
        assertEqualsXX(" 5 GetValue - Float  Field ", "-232.343", getFldValue(fldFloat));
        assertEqualsXX(" 6 GetValue - Num  Field ", "-3456", getFldValue(fldNum));
        assertEqualsXX(" 7 GetValue - Num Right Just", "-123", getFldValue(fldNumRightJust));
        assertEqualsXX(" 8 GetValue - Num Zero Padded Field ", "-456", getFldValue(fldNumZeroPadded));
        assertEqualsXX(" 9 GetValue - Postive Int ", "127890", getFldValue(fldPostiveInt));
        assertEqualsXX("10 GetValue - Assumed Decimal ", "-123.4500",
                getFldValue(fldAssummedDecimal));
        assertEqualsXX("11 GetValue - Num 2 Decimal ", "-23.67", getFldValue(fldNum2decimal));
        assertEqualsXX("12 GetValue - Decimal ", "1234567.00", getFldValue(fldDecimal2digits));
        assertEqualsXX("13 GetValue - Positive Int ", "23123.45", getFldValue(fldPositiveInt2digit));

        assertEqualsXX("14 GetValue - Num 2 Decimal Digits ", "-34.56", getFldValue(fldNum2decimal1));
        assertEqualsXX("15 GetValue - Mainframe Binary ", "-54321", getFldValue(fldMainframeInt));
        assertEqualsXX("16 GetValue - Mainframe Binary with Decimal",
                "-4000000.00", getFldValue(fldMainframeInt2decimal));
        assertEqualsXX("17 GetValue - Byte ", "-128", getFldValue(fldByte));
        assertEqualsXX("18 GetValue - Small Int ", "-31000", getFldValue(fldSmallInt));
        assertEqualsXX("19 GetValue - Int ", "-1000000000", getFldValue(fldInt));
        assertEqualsXX("20 GetValue - Long ", "-100000000000000000", getFldValue(fldLong));
        assertEqualsXX("21 GetValue - Mainframe Small Int ",
                "-31000", getFldValue(fldMainframeSmallInt));
        assertEqualsXX("22 GetValue - Mainframe Long ",
                "-100000000000000000", getFldValue(fldMainframeLong));
        assertEqualsXX("23 GetValue - Mainframe Packed ", "-12345",
                getFldValue(fldMainframePackedDecimal));
        assertEqualsXX("24 GetValue - Mainframe Packed with decimal",
        ...
        assertEqualsXX("27 GetValue - Bit 1byte ", "11000000", getFldValue(fldBit1));
        assertEqualsXX("28 GetValue - Bit 2byte ", "1100000110000011", getFldValue(fldBit2));
    }
    ...
    @Test public void testZoned() throws RecordException {
        ...
        for (i = 0; i < 10; i++) {
            ...
            assertEqualsXX("Zoned Error on +" + i + " " + t + " <> " + s, s, t);
        }
        //getFldValue(fld);
    }


    @Test public void testZoned2() throws RecordException {
    ...
    private void checkAssignment(String msg, FieldDetail fld,  String val)
        ...
        setFldValue(fld, val);
        s = getFldValue(fld);
        assertEqualsXX(msg + " " + s + " <> " + val, val, s);
    }
    ...
    private void checkAssignmentHex(String msg, FieldDetail fld,  String val, String hexVal)
        ...
        assertEqualsXX(msg + " hex check " + s + " <> " + hexVal, hexVal, s);
/*        if (!s.equals(hexVal)) {
    ...
    private void checkAssignmentText1(String msg, FieldDetail fld,  String val, String text)
    		throws RecordException {
    	        ...
    	        s = getFldValue(fld);
    	        assertEqualsXX(msg + " " + s + " <> " + val, text, s);
    	    }
     ...
     *
     */
    @Test public void testMainframe() {
        ...
        assertEqualsXX("Testing Mainframe getField " + expected + " <> " + s,
                expected, s);
    ...
    private void assertEqualsXX(String msg, String expected, String actual) {
