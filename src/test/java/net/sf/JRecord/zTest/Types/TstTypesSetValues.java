 ...
 *
 */
public class TstTypesSetValues extends JUnit3Test  {
	...
	@Test public void testBigEndian1() throws RecordException {
	...
	@SuppressWarnings("deprecation")
	@Test public void testLittleEndian1() throws RecordException {
	...
	@SuppressWarnings("deprecation")
	@Test public void testPackedDecimal1() throws RecordException {
	...
	@SuppressWarnings("deprecation")
	@Test public void testZonedDecimal1() throws RecordException {
...
//	String[] charsets = TstConstants.EBCDIC_CHARSETS;
	...
	@Test public void testGeneral1() throws RecordException {
	...
	@Test public void testGeneral2() throws RecordException {
	...
	@SuppressWarnings("deprecation")
	@Test public void testGeneral3() throws RecordException {
	...
	@Test public void testBigEndian3() throws RecordException {
		tstField3(Type.ftBinaryBigEndian);
	}
	

	@Test public void testLittleEndian3() throws RecordException {
	 ...
	 */
	@Test public void testBigEndianSet4() throws RecordException {
	 ...
	 * @throws RecordException any error that occurs 
	 */
	@Test public void testLittleEndianSet4() throws RecordException {
	...
	private void tstField1(int typeId, int decimalPlaces, String font, int inc) throws RecordException{
		...
		for (int j = 0; j < numValues.length; j++) {
			...
			assertEqualsV3o(id + ":" + j + " " + numValues[j][0] + " " + decimalPlaces + ", " + j, numValues[j][decimalPlaces+1], v.toString());
			...
			if (t instanceof TypeNum && ! ((TypeNum) t).isPositive()) {
				...
				v = t.getField(bb, 1, fldDef);
				assertEqualsV3o(id + numValues[j][0] + " " + decimalPlaces + ", " + j, "-" +  numValues[j][decimalPlaces+1], v.toString());
			}
		}
		...
		for (int i = 0; i < 1200000; i+=inc) {
			...
			if (decimalPlaces == 0) {
				assertEqualsV3o(id + s + " " + decimalPlaces, s, v.toString());
			} else {
				assertEqualsV3o(id + s + " " + decimalPlaces, s + ".0000".substring(0, decimalPlaces + 1), v.toString());
				
				bb = t.setField(bytes, 1, fldDef, s + ".123");
				v = t.getField(bb, 1, fldDef);
				assertEqualsV3o(id + s + " " + decimalPlaces, s + ".1230".substring(0, decimalPlaces + 1), v.toString());
			}
		}
	}
	...
	private void tstField2(int typeId, int decimalPlaces, String font, int inc) throws RecordException{
		...
		for (int i = 0; i < 1200000; i+=inc) {
			...
			if (decimalPlaces == 0) {
				...
				assertEqualsV3o(id + s + " " + decimalPlaces, s, t.getField(bb, 1, fldDef).toString());
				...
				bb = t.setField(bytes, 1, fldDef, bd.add(bdDecimal));
				assertEqualsV3o(id + s + " " + decimalPlaces, s + ".1230".substring(0, decimalPlaces + 1), t.getField(bb, 1, fldDef).toString());
				bb = t.setField(bytes, 1, fldDef, BigInteger.valueOf(i));
				assertEqualsV3o(id + s + " " + decimalPlaces, s + ".0000".substring(0, decimalPlaces + 1), t.getField(bb, 1, fldDef).toString());
			}
		}
	}
	...
	private void tstField3(int typeId, int decimalPlaces) throws RecordException{
		...
		for (int ii = 0; ii < 500000; ii+=1) {
			...
			if (decimalPlaces == 0) {
				...
				assertEqualsV3o("Testing " + ss + " " + decimalPlaces, s, t.getField(bb, 1, fldDef).toString());
				bb = t.setField(bytes, 1, fldDef, bd);
				assertEqualsV3o("Testing " + ss + " " + decimalPlaces, s, t.getField(bb, 1, fldDef).toString());
...
//				assertEquals("Testing " + ss + " " + idx, s, t.getField(bb, 1, fldDef).toString());
				...
				bb = t.setField(bytes, 1, fldDef, ss);
				assertEqualsV3o("Testing " + ss + " " + decimalPlaces, ss.substring(0, decimalPlaces + s.length() + 1), t.getField(bb, 1, fldDef).toString());
				bb = t.setField(bytes, 1, fldDef, bd);
				assertEqualsV3o("Testing " + ss + " " + decimalPlaces, ss.substring(0, decimalPlaces + s.length() + 1), t.getField(bb, 1, fldDef).toString());
				bb = t.setField(bytes, 1, fldDef, new BigInteger(s));
				assertEqualsV3o("Testing " + ss + " " + decimalPlaces, s + ".0000".substring(0, decimalPlaces + 1), t.getField(bb, 1, fldDef).toString());
			}
		}
	}
	...
	private void tst4(int typeId, int adj) throws RecordException {
		...
		for (int i = 0; i < 100; i++) {
			...
			assertEqualsV3i("Test a: " + i, i, bb[1 - adj]);
			assertEqualsV3i("Test a: " + i, 0, bb[adj]);
			
			bb = t.setField(bytes, 1, fldDef, i * 256 + i);
			assertEqualsV3i("Test a: " + i, i, bb[1 - adj]);
			assertEqualsV3i("Test a: " + i, i, bb[adj]);
			
			
			bb = t.setField(bytes, 1, fldDef, i * 256);
			assertEqualsV3i("Test a: " + i, 0, bb[1 - adj]);
			assertEqualsV3i("Test a: " + i, i, bb[adj]);
		}
	}
