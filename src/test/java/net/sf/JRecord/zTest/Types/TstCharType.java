...
public class TstCharType  {
    ...
    private static FieldDetail fldChar, fldCharPadded, fldCharNullTerminated;
    ...
    @Test public void testGetValue() {
        ...
        assertEquals(
        		"asd", getFldValue(fldChar),
        		" 1 GetValue - Character Field ");
        System.out.println("!" +  getFldValue(fldCharPadded) + "!");
        System.out.println("!" +  getFldValue(fldCharNullTerminated) + "!");
        assertEquals( "qwe", getFldValue(fldCharPadded),
        		" 2 GetValue - Character null padded ");
        assertEquals("qwe", getFldValue(fldCharNullTerminated),
        		" 3 GetValue - Character null terminated ");
    }
    ...
    @Test public void testEbcdicCharsets() throws RecordException {
    	tstCharsets(TstConstants.EBCDIC_SINGLE_BYTE_CHARSETS);
    }

    @Test public void testStdCharsets() throws RecordException {
    	String[] charsets = {"", "cp1525", "utf-8"};
    	tstCharsets(charsets);
    }
   

    @Test public void testStdCharsets1() throws RecordException {
...
//  }
    ...
    private static FieldDetail getType(int pos, int len, int type, int decimal, String charset) {
	...
	throws RecordException {
        ...
        s = getFldValue(fld);
        assertEquals( text, s, msg + " " + s + " <> " + text);
    }
    ...
    @Test public void test4Pad() throws RecordException {
