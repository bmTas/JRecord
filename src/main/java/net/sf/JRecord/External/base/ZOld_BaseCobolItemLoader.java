...
public class ZOld_BaseCobolItemLoader<XRecord extends BaseExternalRecord<XRecord>> {
	...
	public ZOld_BaseCobolItemLoader(boolean useJRecordNaming, IExernalRecordBuilder<XRecord> recBuilder) {
		super();
