...
/**
 * Abstract record that can be edited by the user and keeps track
 * of whether it is new Record / updated Record.
 * It is important to keep track of whether the record has been update for
 * DB updates.
 *
