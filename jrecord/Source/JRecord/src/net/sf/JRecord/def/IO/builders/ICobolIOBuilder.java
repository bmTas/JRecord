 ...
 *
 */
public interface ICobolIOBuilder extends IIOBuilder {
	 ...
	 *
	 */
	public abstract ICobolIOBuilder setRecordSelection(String recordName, ExternalSelection selectionCriteria);
	/**
