...
public interface ICobol2Xml  {
	 ...
	 */
	public abstract ICobol2Xml setFileOrganization(int fileOrganization);
	 ...
	 * </pre>
	 */
	public abstract ICobol2Xml setSplitCopybook(int splitCopybook);
	 ...
	 */
	public abstract ICobol2Xml setFont(String font);
	 ...
	 *
	 */
	public abstract ICobol2Xml setRecordSelection(String recordName, ExternalSelection selectionCriteria);
	/**
	 ...
	 */
	public abstract ICobol2Xml setCopybookFileFormat(int copybookFileFormat);
...
//	public abstract ICobol2Xml setDropCopybookNameFromFields(boolean dropCopybookNameFromFields);
	...
	public ICobol2Xml setXmlMainElement(String xmlMainElement);
