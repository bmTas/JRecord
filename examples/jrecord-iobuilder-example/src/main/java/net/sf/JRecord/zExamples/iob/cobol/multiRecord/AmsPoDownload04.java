...
public class AmsPoDownload04 {
    ...
    private AmsPoDownload04() throws Exception {
    	...
    	ICobolIOBuilder ioBldr = JRecordInterface1.COBOL
    				.newIOBuilder(copyName)
    					...
    					.setSplitCopybook(CopybookLoader.SPLIT_01_LEVEL)
       					...
       					.setRecordSelection(PO_RECORD, selBldr.newFieldSelectionEquals("Record-Type", "H1"))
       					.setRecordSelection(PRODUCT_RECORD, selBldr.newFieldSelectionEquals("Record-Type", "D1"))
       					.setRecordSelection(LOCATION_RECORD, selBldr.newFieldSelectionEquals("Record-Type", "S1"))
